...
class TestMiniStatement():
    ...
    def test_testMS2negativeNum(self):
        self.driver.get("https://demo.guru99.com/V4/manager/Managerhomepage.php")
        self.driver.set_window_size(919, 695)
        self.driver.execute_script("""
                       let footer = document.querySelector('p.barone');
    ...
    def test_testMS3alphabets(self):
        self.driver.get("https://demo.guru99.com/V4/manager/Managerhomepage.php")
        self.driver.set_window_size(919, 695)
        self.driver.execute_script("""
                       let footer = document.querySelector('p.barone');
    ...
    def test_testMS5specialCharacters(self):
        self.driver.get("https://demo.guru99.com/V4/manager/Managerhomepage.php")
        self.driver.set_window_size(919, 695)
        self.driver.execute_script("""
                       let footer = document.querySelector('p.barone');
    ...
    def test_testMS6leadingZero(self):
        self.driver.get("https://demo.guru99.com/V4/manager/Managerhomepage.php")
        self.driver.set_window_size(919, 695)
        self.driver.execute_script("""
                       let footer = document.querySelector('p.barone');
    ...
    def test_testMS7longNumber(self):
        self.driver.get("https://demo.guru99.com/V4/manager/Managerhomepage.php")
        self.driver.set_window_size(919, 695)
        self.driver.execute_script("""
                       let footer = document.querySelector('p.barone');
